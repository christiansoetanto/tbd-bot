...
func getTerraSanctaStagingGuildConfig() GuildConfig {
	return GuildConfig{
		...
		RegisteredFeature: map[string]bool{
			...
			domain.FeatureKeySDOfficeOfReadings:   false,
			domain.FeatureKeySDCalendar:           false,
			domain.FeatureKeyCalendarCron:         false,
			domain.FeatureKeyOfficeOfReadingsCron: false,
